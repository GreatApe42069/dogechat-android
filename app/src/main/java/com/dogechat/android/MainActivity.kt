...
class MainActivity : OrientationAwareActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try { com.dogechat.android.service.MeshForegroundService.start(applicationContext) } catch (_: Exception) { }
        meshService = com.dogechat.android.service.MeshServiceHolder.getOrCreate(applicationContext)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "dogechat" || uri.host != "verify") return
