package com.dogechat.android.crypto
...
import com.dogechat.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in dogechat.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "dogechat_crypto"
        private const val SECURE_PREFS_NAME = "dogechat_crypto_secure"
    }
