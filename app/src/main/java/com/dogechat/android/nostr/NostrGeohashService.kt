...
class NostrGeohashService(
    ...
    private val dataManager: com.dogechat.android.ui.DataManager,
    private val notificationManager: com.dogechat.android.ui.NotificationManager
) {
    ...
    companion object {
        ...
        fun initialize(
            ...
            dataManager: com.dogechat.android.ui.DataManager,
            notificationManager: com.dogechat.android.ui.NotificationManager
        ): NostrGeohashService {
    ...
    private fun handleNostrMessage(giftWrap: NostrEvent) {
        ...
        try {
            ...
            if (noisePayload.type == com.dogechat.android.model.NoisePayloadType.PRIVATE_MESSAGE) {
    ...
    private fun checkAndTriggerGeohashNotifications(
        ...
        try {
            ...
            if (isMention || isFirstMessage) {
                ...
                // Launch a coroutine on Main to perform UI/notification work
     ...
     * Check if this is the first message in a subscribed geohash chat
     */
    private fun checkIfFirstMessage(geohash: String, message: DogechatMessage): Boolean {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkeyHex != null) {
            ...
            // Add system message
            val systemMessage = com.dogechat.android.model.DogechatMessage(
                sender = "system",
    ...
    private fun getLocationNameForGeohash(geohash: String): String? {
        return try {
            val locationManager = com.dogechat.android.geohash.LocationChannelManager.getInstance(application)
