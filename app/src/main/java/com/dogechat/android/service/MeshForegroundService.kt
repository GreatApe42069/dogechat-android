package com.dogechat.android.service
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "dogechat_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.dogechat.android.service.START"
        const val ACTION_STOP = "com.dogechat.android.service.STOP"
        const val ACTION_QUIT = "com.dogechat.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.dogechat.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.dogechat.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private fun buildNotification(activeUsers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_dogechat),
                quitPendingIntent
            )
            .build()
    }
