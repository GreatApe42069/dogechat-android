...
import com.dogechat.android.util.dataFromHexString
import com.dogechat.android.util.hexEncodedString
...
object VerificationService {
    private const val CONTEXT = "dogechat-verify-v1"
    private const val RESPONSE_CONTEXT = "dogechat-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "dogechat" || uri.host != "verify") return null
