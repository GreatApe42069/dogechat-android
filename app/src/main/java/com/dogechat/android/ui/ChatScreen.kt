...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.dogechat.android.geohash.ChannelID.Location
    }
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.dogechat.android.geohash.LocationChannelManager.getInstance(context) }
