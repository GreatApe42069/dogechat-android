    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerID.startsWith("nostr_")) {
                ...
                if (nostrPubkeyHex != null) {
                    // For nostr-only peers, create a synthetic noise key for storage compatibility
                    // Use the nostr pubkey bytes (take first 32 bytes)
                    try {
            ...
            if (noiseKey != null) {
                ...
                try {
                    ...
                    // Prefer mesh if session established, else try Nostr for mesh peers
