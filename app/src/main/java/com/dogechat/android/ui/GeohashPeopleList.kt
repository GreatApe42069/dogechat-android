        ...
        if (geohashPeople.isEmpty()) {
            ...
            val baseNameCounts = remember(geohashPeople) {
                ...
                geohashPeople.forEach { person ->
                    val (b, _) = com.dogechat.android.ui.splitSuffix(person.displayName)
            ...
            orderedPeople.forEach { person ->
                GeohashPersonItem(
                    ...
                    viewModel = viewModel,
                    showHashSuffix = (baseNameCounts[com.dogechat.android.ui.splitSuffix(person.displayName).first] ?: 0) > 1,
                    onTap = {
                        if (person.id != myHex) {
...
private fun GeohashPersonItem(
    ...
    Row(
        ...
        val (baseNameRaw, suffixRaw) = com.dogechat.android.ui.splitSuffix(person.displayName)
