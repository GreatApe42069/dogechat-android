package com.dogechat.android.ui.debug
...
import com.dogechat.android.services.meshgraph.MeshGraphService
...
import com.dogechat.android.core.ui.component.sheet.DogechatBottomSheet
import com.dogechat.android.core.ui.component.sheet.DogechatSheetTopBar
import com.dogechat.android.core.ui.component.sheet.DogechatSheetTitle
        ...
        if (isPresented) {
            ...
            while (true) {
                ...
                val devices = entries.map { (address, isClient, rssi) ->
                    ...
                    com.dogechat.android.ui.debug.ConnectedDevice(
            ...
            item {
                Surface(shape = RoundedCornerShape(12.dp), color = colorScheme.surfaceVariant.copy(alpha = 0.2f)) {
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        ...
                        val p = remember(gcsFpr) { com.dogechat.android.sync.GCSFilter.deriveP(gcsFpr / 100.0) }
                        val nmax = remember(gcsFpr, gcsMaxBytes) { com.dogechat.android.sync.GCSFilter.estimateMaxElementsForSize(gcsMaxBytes, p) }
