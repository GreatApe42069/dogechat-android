...
cp "$aab_source" "$OUTPUT_DIR/dogechat-android-release-unsigned.aab"
...
declare -A apk_names=(
  ["app-arm64-v8a-release-unsigned.apk"]="dogechat-android-arm64-unsigned.apk"
  ["app-armeabi-v7a-release-unsigned.apk"]="dogechat-android-armv7-unsigned.apk"
  ["app-universal-release-unsigned.apk"]="dogechat-android-universal-unsigned.apk"
  ["app-x86-release-unsigned.apk"]="dogechat-android-x86-unsigned.apk"
  ["app-x86_64-release-unsigned.apk"]="dogechat-android-x86_64-unsigned.apk"
)
...
(
  cd "$OUTPUT_DIR"
  {
    ...
    sha256sum dogechat-android-*-unsigned.apk
    sha256sum dogechat-android-release-unsigned.aab
