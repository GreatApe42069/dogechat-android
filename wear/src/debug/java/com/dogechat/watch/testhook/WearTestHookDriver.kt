package com.dogechat.watch.testhook

import android.content.Context
import android.content.Intent
import android.util.Log
import com.dogechat.android.model.RoutedPacket
import com.dogechat.android.features.voice.LiveVoiceEvent
import com.dogechat.android.features.voice.LiveVoiceManager
import com.dogechat.android.features.voice.LiveVoicePreferences
import com.dogechat.android.features.voice.LiveVoiceScope
import com.dogechat.android.features.voice.LiveVoiceTarget
import com.dogechat.android.features.voice.LiveVoiceCapture
import com.dogechat.android.model.DogechatFilePacket
import com.dogechat.android.noise.NoiseSession
import com.dogechat.android.protocol.DogechatPacket
import com.dogechat.android.service.TransportBridgeService
...
object WearTestHookDriver {
    ...
    private suspend fun msgRecv(context: Context, intent: Intent): JSONObject {
        ...
        val startTime = System.currentTimeMillis()
        val mesh = mesh(context)
        val matches: (com.dogechat.android.model.DogechatMessage) -> Boolean = { msg ->
            msg.timestamp.time >= startTime &&
                msg.senderPeerID != mesh.myPeerID &&
                (contains == null || msg.content.contains(contains))
        }
        ...
        return ok("favorite_status")
            ...
            .put(
                ...
                when (identity.favoriteIndicator) {
                    com.dogechat.watch.ui.FavoriteIndicator.Favorite -> "filled"
                    com.dogechat.watch.ui.FavoriteIndicator.FavoritedUs -> "outlined_orange"
                    com.dogechat.watch.ui.FavoriteIndicator.None -> "outlined"
                }
            )
    }
