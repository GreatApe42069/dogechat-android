 ...
 *
 *   adb shell am broadcast -a com.dogechat.watch.TEST_HOOK \
 *     --es cmd <command> --es id <cmd-id> [command extras...]
 *
 * Result is written to cache/testhook/results/<id>.json (readable via run-as com.dogechat.watch)
...
class WearTestHookReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "com.dogechat.watch.TEST_HOOK"
