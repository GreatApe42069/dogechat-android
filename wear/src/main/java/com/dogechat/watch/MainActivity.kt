...
import com.dogechat.watch.service.WearMeshForegroundService
import com.dogechat.watch.ui.ChatScreen
import com.dogechat.watch.ui.DmScreen
import com.dogechat.watch.ui.NicknameSetupScreen
import com.dogechat.watch.ui.PeopleScreen
import com.dogechat.watch.ui.UserDetailScreen
import com.dogechat.watch.ui.VerificationCodeScreen
import com.dogechat.watch.ui.WearChatState
import com.dogechat.watch.ui.sendPrivateMessage
import com.dogechat.watch.ui.sendPublicMessage
import com.dogechat.watch.ui.theme.DogechatWearTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nicknameChosen = getSharedPreferences("dogechat_watch_prefs", Context.MODE_PRIVATE)
            ...
            DogechatWearTheme {
                when {
                    ...
                    !nicknameChosen -> NicknameSetupScreen(
                        ...
                        getSharedPreferences("dogechat_watch_prefs", Context.MODE_PRIVATE)
    ...
    override fun onResume() {
        super.onResume()
        com.dogechat.android.features.voice.LiveVoiceManager.getInstance(applicationContext)
...
internal fun WearNavHost(
    ...
    AnimatedContent(
        ...
        transitionSpec = {
            fadeIn(tween(com.dogechat.watch.ui.theme.DogechatMotion.EMPHASIZED_MS)) togetherWith
                fadeOut(tween(com.dogechat.watch.ui.theme.DogechatMotion.QUICK_MS))
        },
        ...
        when (current) {
            ...
            is WearScreen.TextInput -> {
                ...
                com.dogechat.watch.ui.TextInputScreen(
                    onSend = { text ->
                        mesh?.let { m ->
