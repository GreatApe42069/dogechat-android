package com.dogechat.watch.notification
...
class WearNotificationCoordinator private constructor(context: Context) {
    ...
    companion object {
        const val EXTRA_OPEN_DM = "com.dogechat.watch.extra.OPEN_DM"
        const val EXTRA_PEER_ID = "com.dogechat.watch.extra.PEER_ID"

        private const val MESSAGE_CHANNEL_ID = "dogechat_watch_messages"
