package com.dogechat.watch.service
...
import com.dogechat.watch.MainActivity
...
import com.dogechat.watch.notification.WearNotificationPolicy
...
class WearMeshForegroundService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "dogechat_mesh"
    ...
    private fun handlePrivateMessage(message: DogechatMessage) {
