package com.dogechat.watch.ui.theme
...
val DogechatFontFamily = FontFamily(
...
val DogechatWearTypography = Typography(
    defaultFontFamily = DogechatFontFamily,
)

object ChatVisualTokens {
    val MessageBodyStyle = TextStyle(
        fontFamily = DogechatFontFamily,
